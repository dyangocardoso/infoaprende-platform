/**
 * Tema 3: Manejo del ratón (MIGRADO)
...
export default {
  ...
  secciones: [
    {
      ...
      actividades: [
        {
          tipo: "practica",
          descripcion: "Evalúa y corrige tu postura actual",
          pasos: [
            "Siéntate frente al computador",
            "Verifica la posición de tus pies y espalda",
            "Ajusta la altura de la silla si es necesario",
            "Coloca tu mano sobre el ratón naturalmente",
            "Practica el agarre correcto por 2 minutos"
          ]
        }
      ]
    },
    {
      ...
      actividades: [
        {
          tipo: "practica",
          descripcion: "Practica los diferentes tipos de movimiento y clics",
          pasos: [
            "Mueve el cursor en círculos grandes",
            "Practica líneas rectas de esquina a esquina",
            "Haz clic simple en varios iconos",
            "Practica doble clic en carpetas",
            "Usa clic derecho en diferentes elementos",
            "Usa la rueda para desplazarte en páginas web"
          ]
        }
      ]
    }
  ...
  recursos: {
    documentos: [
      {
        titulo: "Ergonomía en el uso del computador",
        url: "/docs/ergonomia-computador.pdf",
        tipo: "pdf"
      }
    ],
    enlaces: [
      {
        titulo: "Ejercicios de coordinación mouse-cursor",
        url: "https://example.com/ejercicios-raton",
        tipo: "externo"
      }
    ],
    videos: [
      {
        titulo: "Técnica correcta del ratón",
        url: "/videos/tecnica-raton.mp4",
        duracion: "4:20"
      }
    ]
  },
  evaluacion: {
    ...
    preguntas: [
      {
        pregunta: "¿Cuál es la postura correcta de la muñeca al usar el ratón?",
      ...
      {
        pregunta: "¿Para qué se usa el doble clic?",
        tipo: "opcion_multiple",
        opciones: [
          "Seleccionar texto",
      ...
      {
        pregunta: "¿Qué botón del ratón muestra el menú contextual?",
        tipo: "opcion_multiple",
        opciones: [
          "Botón izquierdo",
          "Botón derecho",
